    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900">{{ $userStats['completed_quizzes'] }}</dd>
                        </dl>
                        <div class="mt-1">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900">{{ number_format($userStats['average_score'], 1) }}</dd>
                        </dl>
                        <div class="mt-1">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900">{{ $userStats['total_attempts'] }}</dd>
                        </dl>
                        <div class="mt-1">
        ...
        <div class="bg-white rounded-2xl shadow-large overflow-hidden animate-slide-up" style="animation-delay: 0.4s">
            ...
            <div class="px-4 py-16 sm:px-6 text-center animate-pulse">
                ...
                <h3 class="text-xl font-medium text-gray-900 mb-2">Belum ada quiz tersedia</h3>
                <p class="text-gray-500 mb-6 max-w-md mx-auto">Saat ini belum ada quiz yang aktif. Silakan kembali nanti!</p>
                    ...
                    <div class="quiz-card bg-white rounded-2xl border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl group cursor-pointer flex flex-col h-full">
                        ...
                        <div class="relative bg-gradient-to-r from-indigo-500 to-purple-600 p-4">
                            ...
                            <div class="absolute top-3 right-3">
                                <span class="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-3 py-2 rounded-full text-xs font-semibold flex items-center shadow-lg shadow-emerald-500/30 transition-all duration-300">
                            ...
                            <div class="absolute top-3 right-3">
                                <span class="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-3 py-2 rounded-full text-xs font-semibold flex items-center shadow-lg shadow-amber-500/30 transition-all duration-300 animate-pulse">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-indigo-100 text-sm mt-1 truncate">
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            ...
                            <div class="mt-auto pt-4">
                                ...
                                <a href="{{ route('quiz.show', $quiz->id) }}"
                                   class="w-full inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105 group/btn shadow-sm">
                                    <i class="fas fa-redo mr-2 group-hover/btn:rotate-180 transition-transform duration-500"></i>
                                    Coba Lagi
                                </a>
                                @else
                                <a href="{{ route('quiz.show', $quiz->id) }}"
                                   class="w-full inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105 group/btn shadow-sm">
                                    <i class="fas fa-play mr-2 group-hover/btn:translate-x-1 transition-transform duration-300"></i>
                                    Mulai Quiz
                                </a>
                                @endif
                            </div>
        ...
        <div class="mt-8 bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl p-8 text-center text-white animate-slide-up" style="animation-delay: 0.5s">
            <div class="max-w-2xl mx-auto">
                <div class="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-graduation-cap text-2xl"></i>
                </div>
                <h3 class="text-2xl font-bold mb-4">Tingkatkan Kemampuanmu Setiap Hari</h3>
...
<style>
    ...
    .quiz-card {
        ...
        min-height: 280px; /* Memberikan tinggi minimum yang konsisten */
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        quizCards.forEach(card => {
            card.addEventListener('mouseenter', function() {
                ...
                // For example: new Audio('/sounds/hover.mp3').play().catch(() => {});
            });
        });
    });
</script>
